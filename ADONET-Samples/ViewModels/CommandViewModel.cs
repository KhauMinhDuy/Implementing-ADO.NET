...
namespace ADONET_Samples.ViewModels
{
    public class CommandViewModel : ViewModelBase
    {
        ...
        private Product _SearchEntity = new Product { ProductName = "T%" };
        #endregion
        ...
        public int InsertProduct()
        {
            ...
            // Create SQL statement to submit
            string sql = "INSERT INTO Product(ProductName, IntroductionDate, Url, Price) VALUES('VB.NET Fundamentals', '2019-05-21', 'https://bit.ly/30KKHjs', 19.99)";
        ...
        public int InsertProductUsingParameters()
        {
            ...
            // Create SQL statement to submit
            string sql = "INSERT INTO Product(ProductName, IntroductionDate, Url, Price) VALUES(@ProductName, @IntroductionDate, @Url, @Price)";
            ...
            try
            {
                ...
                using (SqlConnection cnn = new SqlConnection(AppSettings.ConnectionString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(sql, cnn))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter { ParameterName = "@ID", Value = InputEntity.ProductId, IsNullable = false, DbType = System.Data.DbType.Int32, Direction = ParameterDirection.Output });
                        ...
                        InputEntity.ProductId = (int)cmd.Parameters["@ID"].Value;
                        RaisePropertyChanged("InputEntity");
