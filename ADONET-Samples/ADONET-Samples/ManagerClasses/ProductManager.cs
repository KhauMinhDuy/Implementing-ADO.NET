...
namespace ADONET_Samples.ManagerClasses
{
    ...
    {
        public const string PRODUCT_SQL = "SELECT ID, ProductName, IntroductionDate, Url, Price, RetireDate, ProductCategoryId FROM Product";
        public const string PRODUCT_CATEGORY_SQL = "SELECT ID, CategoryName FROM ProductCategory";
